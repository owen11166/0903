...
<html data-wf-page="64e89888b01a38fc787238ee" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
      ...
      <div class="f-container-x-small-2">
        <div class="f-margin-bottom-70">
          <div class="f-title-wrapper-left-2">
            <div class="f-margin-bottom-69"></div>
            <div class="f-margin-bottom-68">
              <h2 class="f-h3-heading-5">註冊成功！歡迎加入 5TEAM</h2>
            </div>
            <p class="f-paragraph-large-3">請按下方按鈕立即登入</p>
          </div>
        </div>
        <div class="w-form">
		<div>
    		<a href="<c:url value='/login'/>" class="f-button-neutral-4 w-button">登入</a>
		</div>
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="64e89888b01a38fc787238ee" data-wf-element-id="7cbe9da6-3789-9dfe-6098-76e10e14e779">
