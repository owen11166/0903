...
<!--  Last Published: Fri Aug 25 2023 12:15:46 GMT+0000 (Coordinated Universal Time)  -->
<html data-wf-page="64e8682c4c784ca827c91f25" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>首頁</title>
...
<body>
  ...
  <div class="page-wrapper">
      ...
      <div class="nav-main">
        <div class="wrapper nav-bar-wrapper">
          <a href="index.html" aria-current="page" class="brand w-nav-brand w--current">
            <div><img src="images/LOGO.png" loading="lazy" width="214" sizes="(max-width: 479px) 100vw, 214px" srcset="images/LOGO-p-500.png 500w, images/LOGO.png 556w" alt=""></div>
          </a>
          <div class="navigation">
            <nav role="navigation" class="nav-menu w-nav-menu">
             	<a  href="<c:url value='/'/>"aria-current="page" class="nav-link w-nav-link w--current">首頁</a>
              <div data-hover="false" data-delay="0" class="w-dropdown">
                ...
                <nav class="w-dropdown-list">
                  <a href="index.html" aria-current="page" class="w-dropdown-link w--current">射擊遊戲</a>
                  <a href="index.html" aria-current="page" class="w-dropdown-link w--current">動作冒險</a>
                  <a href="index.html" aria-current="page" class="w-dropdown-link w--current">角色扮演</a>
                  <a href="index.html" aria-current="page" class="w-dropdown-link w--current">即時戰略</a>
                  <a href="index.html" aria-current="page" class="w-dropdown-link w--current">卡牌策略</a>
                </nav>
              </div>
              ...
              <div><img src="images/avatar.png" loading="lazy" width="68" alt=""></div>
              <a href="index.html" aria-current="page" class="nav-link w-nav-link w--current">會員中心</a>
    ...
    <div class="section hero-section">
      <div class="wrapper text-white">
        <div style="-webkit-transform:translate3d(0, 0, 0) scale3d(0.5, 0.5, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-moz-transform:translate3d(0, 0, 0) scale3d(0.5, 0.5, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);-ms-transform:translate3d(0, 0, 0) scale3d(0.5, 0.5, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);transform:translate3d(0, 0, 0) scale3d(0.5, 0.5, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0);opacity:0" class="hero-intro">
          <div class="title">Say Hello to 5team</div>
          <h1>歡迎來到5team遊戲商城</h1>
          <a href="#Scroll-Section" class="button w-button">開始瀏覽</a>
        </div>
      </div>
    ...
    <section class="testimonial-slider-large-2">
      <div class="container-2">
        <div data-delay="4000" data-animation="slide" class="testimonial-slider-two-2 w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit="0" data-nav-spacing="12" data-duration="500" data-infinite="true">
    ...
    <section class="testimonial-slider-large">
      ...
      <div data-w-id="e89551e9-b5ae-51a6-c418-02c90497790c" class="subscribe">
        ...
        <div class="subscribe-form-wrapper w-form">
          <form id="wf-form-Subscribe-Form" name="wf-form-Subscribe-Form" data-name="Subscribe Form" method="get" class="subscribe-form" data-wf-page-id="64e8682c4c784ca827c91f25" data-wf-element-id="e89551e9-b5ae-51a6-c418-02c904977917"><input type="text" class="input subscribe-input w-input" maxlength="256" name="search" data-name="search" placeholder="搜尋商品" id="search" required=""><input type="submit" value="GO" data-wait="Please wait..." class="button w-button"></form>
    ...
    <div id="Scroll-Section" class="section haze">
      <div class="wrapper">
        <div class="home-categories">
          <div data-w-id="79f09a57-05ab-ed81-c059-4d50244b2341" style="opacity:0" class="home-category-card"><img src="images/angel.png" sizes="(max-width: 479px) 100vw, (max-width: 991px) 176px, 220px" srcset="images/angel-p-500.png 500w, images/angel.png 729w" alt="" width="600" class="home-category-image-1">
            <div class="w-layout-blockcontainer w-container"></div>
            <div class="home-category-info-1">
              <h3>熱門專區</h3>
              <a href="index.html" aria-current="page" class="button small white w-button w--current">立即前往</a>
            </div>
          </div>
          <div data-w-id="b498480a-a03d-afff-8227-912980ab2a0a" style="opacity:0" class="home-category-card red"><img src="images/demon.png" height="220" srcset="images/demon-p-500.png 500w, images/demon-p-800.png 800w, images/demon.png 806w" sizes="(max-width: 479px) 100vw, (max-width: 991px) 176px, 220px" alt="" class="home-category-image-2">
          ...
          <div role="list" class="products w-dyn-items">
            <div data-w-id="86c7c915-bcbe-c30c-93c0-5bed50ef155d" style="opacity:0" role="listitem" class="product-card-wrapper w-dyn-item">
              <a href="#" class="product-card w-inline-block">
                <div class="product-card-image-wrapper"><img src="https://d3e54v103j8qbb.cloudfront.net/plugins/Basic/assets/placeholder.60f9b1840c.svg" alt=""></div>
        ...
        <div class="side-blocks mobile-reverse">
          <div class="side-block no-padding-left">
            <div class="side-info">
              ...
              <p class="text-grey">只要註冊加入我們會員,可以立即獲得<strong>9折優惠券</strong><br>滿額500,1000,5000送優惠,更多優惠等著你<br></p>
              <a href="index.html" aria-current="page" class="button w-button w--current">點即馬上註冊與購買與購買</a>
            </div>
          </div>
          <div class="side-block small-padding-side"><img src="images/coupon.jpg" data-w-id="eaff9f8d-69e6-9e6f-5d07-e920521f8531" sizes="(max-width: 479px) 93vw, (max-width: 767px) 80vw, (max-width: 991px) 81vw, (max-width: 1439px) 45vw, 570px" style="opacity:0" srcset="images/coupon-p-500.jpg 500w, images/coupon.jpg 610w" alt="" class="side-image"></div>
        </div>
      </div>
    </div>
    <section class="footer-light">
      <div class="container">
        <div class="footer-wrapper-two">
          <a href="#" class="footer-brand-2 w-inline-block"><img src="images/LOGO.png" loading="lazy" width="253" sizes="(max-width: 479px) 88vw, 253px" srcset="images/LOGO-p-500.png 500w, images/LOGO.png 556w" alt=""></a>
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="64e8682c4c784ca827c91f25" data-wf-element-id="7cbe9da6-3789-9dfe-6098-76e10e14e779">
      ...
      <div class="footer-bottom-2">
        ...
        <a href="#" class="footer-social-link-2 w-inline-block"><img src="images/facebook-icon-white.svg" loading="lazy" width="96" alt=""></a>
        <a href="#" class="footer-social-link-2 w-inline-block"><img src="images/twitter-icon-white.svg" loading="lazy" width="97" alt=""></a>
        <div class="footer-social-block-two">
          <a href="#" class="footer-social-link-2 w-inline-block"><img src="images/youtube-icon.svg" loading="lazy" width="93" alt=""></a>
        </div>
      </div>
    </section>
  </div>
