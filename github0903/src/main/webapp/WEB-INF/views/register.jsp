...
<html data-wf-page="64e8682c4c784ca827c91f3b" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <title>註冊</title>
 	<style>
    ...
    <div class="f-section-large-2">
      <div class="f-container-x-small">
        <div class="f-margin-bottom-56">
          <div class="f-title-wrapper-left">
            <div class="f-margin-bottom-55">
              <h1 class="f-h3-heading-2">立即註冊</h1>
            </div>
            <p class="f-paragraph-large-2">已經擁有5TEAM帳號嗎?<br>‍</p>
            <a href="#" class="w-button"> 點此登入</a>
          </div>
        </div>
      ...
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="64e8682c4c784ca827c91f3b" data-wf-element-id="7cbe9da6-3789-9dfe-6098-76e10e14e779">
