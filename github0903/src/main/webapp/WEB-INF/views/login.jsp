...
<html data-wf-page="64e8925dd781ac16a148e943" data-wf-site="64e5ed3359b16400aec286b0">
<head>
  <meta charset="utf-8">
  <style>
  .error-message{
         	...
         	<a  href="<c:url value='/'/>"aria-current="page" class="nav-link w-nav-link w--current">首頁</a>
              <div data-hover="false" data-delay="0" class="w-dropdown">
                ...
                <nav class="w-dropdown-list">
                  <a href="../index.html" class="w-dropdown-link">射擊遊戲</a>
                  <a href="../index.html" class="w-dropdown-link">動作冒險</a>
                  <a href="../index.html" class="w-dropdown-link">角色扮演</a>
                  <a href="../index.html" class="w-dropdown-link">即時戰略</a>
                  <a href="../index.html" class="w-dropdown-link">卡牌策略</a>
                </nav>
              </div>
              ...
              <a href="../index.html" class="nav-link w-nav-link">會員中心</a>
...
<%--               <a  href="<c:url value='/login'/>"aria-current="page" class="nav-link w-nav-link w--current">登入</a> --%>
        ...
        <div class="f-margin-bottom-60">
          <div class="f-title-wrapper-left-2">
            <div class="f-margin-bottom-58">
              <h1 class="f-h3-heading-3">立即登入</h1>
            </div>
            <p class="f-paragraph-large-3">尚未擁有5TEAM帳號嗎?<br>‍</p>
            <a href="#" class="w-button">點此註冊</a>
          </div>
        </div>
        <div class="w-form">
			<form id="wf-form-Contact-Form" name="wf-form-Contact-Form" data-name="Contact Form" method="post" class="f-contact-form-3" data-wf-page-id="64e8925dd781ac16a148e943" data-wf-element-id="c1fa8117-d8ce-840c-fbdc-e6e59422d8cf" action="/login">
			    ...
			    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/> <!-- Add CSRF token for security -->
					...
					<% } %>
			    <div class="f-contact-submit-wrapper-2">
			        <input type="submit" value="登入" data-wait="Please wait..." class="f-button-neutral-4 w-button">
			        <div class="f-margin-bottom-57"></div>
			        <div class="f-contact-divider-2"></div>
			    </div>
    ...
    <section class="footer-light">
      <div class="f-section-large">
        ...
        <div class="f-contact-content"></div>
      </div>
      <div class="container">
        <div class="footer-wrapper-two">
          ...
          <div class="footer-form w-form">
            <form id="wf-form-Footer-Form" name="wf-form-Footer-Form" data-name="Footer Form" method="get" class="footer-form-container" data-wf-page-id="64e8925dd781ac16a148e943" data-wf-element-id="7cbe9da6-3789-9dfe-6098-76e10e14e779">
